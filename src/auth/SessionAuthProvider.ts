 ...
 */
export function isSessionAuthProvider(obj: AuthProvider): obj is SessionAuthProvider {
  return 'getAccounts' in obj &&
...
export { AuthProvider, AuthenticationError } from './AuthProvider';